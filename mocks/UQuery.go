...
func (_m *UQuery) CreateUser(_a0 users.Users) error {
	ret := _m.Called(_a0)
...
func (_m *UQuery) DeleteUser(_a0 uint) error {
	ret := _m.Called(_a0)
...
func (_m *UQuery) ReadUser(_a0 uint) (users.Users, error) {
	ret := _m.Called(_a0)
...
func (_m *UQuery) UpdateUser(_a0 uint, _a1 users.Users) error {
